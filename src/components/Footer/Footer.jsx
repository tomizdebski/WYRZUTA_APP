export default function Footer() {
  return (
    <div className="flex flex-col items-center justify-between min-h-[300px] gap-4 bg-[#130F0D] p-10 ">
      <div className="flex flex-col sm:flex-row  xs:items-center  gap-4 lg:items-start justify-between  relative w-[80%]">
        ...
        <div className="flex flex-col gap-1 shrink-0">
          <div className="text-white text-[20px] text-center lg:text-left font-bold  relative ">
            Features{" "}
          </div>
        ...
        <div className="flex flex-col gap-1  shrink-0 relative">
          <div className="text-white text-center text-[20px] xs:text-center lg:text-left font-bold  relative ">
            Company{" "}
          </div>
          <div className="text-white text-center lg:text-left  relative">
            Link Sharing{" "}
        ...
        <div className="flex flex-row gap-[9px] items-start justify-center shrink-0 relative pt-2">
